    ...
    return (
        <div className={styles.container}>
            ...
            <div>
                ...
                <Link href={"https://t.me/OfficialBasedFellas"} target={"_blank"}><FontAwesomeIcon icon="fa-brands fa-telegram" /></Link>
                <Link href={"https://magiceden.io/collections/base/0x217ec1ac929a17481446a76ff9b95b9a64f298cf"} target={"_blank"}><Image priority alt={"melogo"} src={'/images/magiceden.png'} width={25} height={25} /></Link>
