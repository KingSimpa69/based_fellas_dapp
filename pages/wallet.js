...
const Wallet = ({routeChange,router,windowSize,web3Shit,alert,setIsLoading,setFellasModalShit,fellasModalShit,toggleFellasModal,togglePhone,lSBalances,setLSBalances,ownedList,setOwnedList}) => {
    ...
    return( !web3Shit.isConnected ? <WalletNotConnected /> : web3Shit.isConnected && web3Shit.chain !== 8453 ? <WalletWrongChain /> :
        <div className={"wrapper"}>
            ...
            <AssetLoader ownedList={ownedList} setOwnedList={setOwnedList} toggleFellasModal={toggleFellasModal} togglePhone={togglePhone} lSBalances={lSBalances} setLSBalances={setLSBalances} setFellasModalShit={setFellasModalShit} alert={alert} setIsLoading={setIsLoading} web3Shit={web3Shit} page={page}/>
        </div> 
    )
}
